...
/* supports only indian phone no formats */
const phoneRegex = /^[\+]?[(]?((91)|(0))?[)]?[-\s\.]?[789]\d{9}$/im;
...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    coCurricularDsp = document.getElementById('co-curriculars_dsp');
...
const getUserInputs = () => {
    ...
    //co-curriculars
    let coCurricularTitleElem = document.querySelectorAll('.coCurricular_title'),
    coCurricularDescriptionElem = document.querySelectorAll('.coCurricular_description');
...
//coCurriculars
    coCurricularTitleElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Activity')));
    coCurricularDescriptionElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Description')));
    ...
    return {
        ...
        coCurricular: fetchValues(['coCurricular_title', 'coCurricular_description'], coCurricularTitleElem, coCurricularDescriptionElem),
...
const displayCV = (userData) => {
    ...
    showListData(userData.coCurricular, coCurricularDsp);
